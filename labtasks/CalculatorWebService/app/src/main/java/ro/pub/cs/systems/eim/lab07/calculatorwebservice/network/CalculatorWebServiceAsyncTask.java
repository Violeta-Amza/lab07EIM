...
public class CalculatorWebServiceAsyncTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        if (operator1 == null || operator2 == null
            || operator1.isEmpty() || operator2.isEmpty()) {
        ...
        switch (method){
            ...
            case Constants.POST_OPERATION:
                ...
                params_post.add(new BasicNameValuePair(Constants.OPERATION_ATTRIBUTE, operation));
                params_post.add(new BasicNameValuePair(Constants.OPERATOR1_ATTRIBUTE, operator1));
                params_post.add(new BasicNameValuePair(Constants.OPERATOR2_ATTRIBUTE, operator2));
                ResponseHandler<String> responseHandlerPost = new BasicResponseHandler();
                try {
                    UrlEncodedFormEntity urlEncodedFormEntity = new UrlEncodedFormEntity(params_post, HTTP.UTF_8);
